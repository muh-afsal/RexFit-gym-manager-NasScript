...
import trainer1 from "../assets/images/Screenshot 2024-11-13 100512.png";
  ...
  return (
    <>
      <div className="w-full h-full ">
        ...
        <div className="lg:h-[600px] h-[550px] w-full dark:bg-dark-bg flex justify-center items-center">
            ...
            <div className="lg:h-[70%] h-max  w-full flex p-5 gap-5  overflow-auto">
              ...
              <div className="lg:h-full  lg:w-1/3 w-[300px]  px-8 rounded-xl dark:bg-neutral-900 bg-neutral-200 dark:hover:bg-rex-green hover:text-black  transition duration-200 hover:bg-rex-green">
                ...
                <div className="h-[60%] w-full  p-2 flex flex-col justify-between">
                  ...
                  <h1 className="font-michroma text-[10px]  ">
                    Professional Trainers and their support,we give importance
                    to out clients and their needs.
                  </h1>
        ...
        <div className="lg:h-[700px] h-max pb-10 w-full dark:bg-dark-bg flex justify-center items-center">
          <div className="lg:w-[70%] md:w-[90%] w-[95%] h-[90%] ">
            ...
            <div className=" items-center flex-col md:flex-row h-[1200px] md:h-[360px]  lg:h-[390px] w-full flex p-5 gap-7 md:gap-24  overflow-auto scrollbar-custom">
              <div
                className="h-full relative lg:w-1/3 w-[300px] px-8 rounded-xl transform transition-transform duration-300 hover:scale-105"
                style={{
              ...
              >
                <div className="w-full h-full flex items-end pb-3">
                  <h1 className="font-michroma font-bold text-white">
                    Mark Spector
                  </h1>
                </div>
                <div className="absolute inset-0 bg-black opacity-40 dark:opacity-40 z-[-10px] rounded-lg"></div>
              </div>
        ...
        >
         <div className="absolute  inset-0 bg-black opacity-40 dark:opacity-50 z-[-50px]"></div>
          ...
          <h1 className="font-michroma  md:text-5xl mb-14 mt-6 text-center text-2xl text-white w-full md:w-[70%] flex justify-center  font-extrabold">
            ...
            <div className="relative w-full md:w-[50%]">
              <input
                ...
                className="w-full px-4 text-black  dark:bg-neutral-900/60 bg-neutral-700/80 backdrop-blur-lg py-2 pr-10 rounded-full border border-gray-300 focus:outline-none focus:border-rex-green"
              />
              <button
                type="submit"
        ...
        <div className="h-[350px] w-full dark:bg-dark-bg  p-5">
          <div className="w-full h-full flex-col  flex items-end">
              ...
              <div className="h-full w-full  flex">
                ...
                <div className="w-[60%] h-full  md:flex hidden dark:text-neutral-400 text-neutral-800">
                  <div className="w-1/3 h-full flex items-center gap-6 p-3 flex-col">
                    <h1 className="font-michroma text-sm font-bold dark:text-rex-green text-neutral-800">
                      About us
                    </h1>
            ...
            <div className="h-[60px] dark:text-neutral-600 text-neutral-300 bottom-0  w-full flex justify-center md:justify-start items-center md:pl-16  border-t dark:border-neutral-800 border-neutral-300">
